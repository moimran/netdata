...
import { Box, Button, Container, Group, LoadingOverlay, Paper, Text, TextInput, Title } from '@mantine/core';
...
export function TerminalPage() {
  ...
  // Initialize terminal - following the WebSSH example closely
  useEffect(() => {
    ...
    try {
      ...
      // Create terminal instance with options matching the WebSSH example
      ...
      try {
        ...
        try {
          ...
          if (terminal && deviceInfo) {
            ...
            terminal.writeln(`\r\n\x1b[1;36mDevice:\x1b[0m ${deviceInfo.device_name || 'Device'} (${deviceInfo.ip_address})`);
  ...
  const connectWebSocket = (sessionId: string) => {
    ...
    try {
      ...
      ws.onopen = () => {
        ...
        terminal.writeln(`\x1b[33mYou are now connected to ${deviceDetails?.device_name || 'Device'} (${deviceDetails?.ip_address || 'unknown'})\x1b[0m`);
        ...
        // Handle terminal input - exactly like the WebSSH example
  ...
  return (
    <Container size="xl" py="xl">
      <Paper shadow="sm" p="md" withBorder>
        ...
        <Box pos="relative" h={600} style={{ borderRadius: '5px', overflow: 'hidden' }}>
