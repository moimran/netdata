...
export const STATUS_PLANNED = 'yellow';
export const STATUS_AVAILABLE = 'teal';
export const STATUS_OFFLINE = 'gray';
export const STATUS_FAILED = 'red';
export const STATUS_STAGED = 'orange';
