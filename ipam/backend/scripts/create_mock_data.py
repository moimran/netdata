...
def create_mock_data():
    ...
    with Session(engine) as session:
        ...
        aggregates = [
            Aggregate(
                prefix="10.0.0.0/8",
                description="RFC 1918 Private IPv4 Space - Class A",
                date_added=date.today(),
                rir_id=rirs[3].id  # RFC 1918
            ),
            Aggregate(
                prefix="172.16.0.0/12",
                description="RFC 1918 Private IPv4 Space - Class B",
                date_added=date.today(),
                rir_id=rirs[3].id  # RFC 1918
            ),
            Aggregate(
                prefix="192.168.0.0/16",
                description="RFC 1918 Private IPv4 Space - Class C",
                date_added=date.today(),
                rir_id=rirs[3].id  # RFC 1918
            )
        ]
        ...
        ip_addresses = [
            ...
            IPAddress(
                ...
                name="NYC-APP-01",
                status=IPAddressStatusEnum.ACTIVE,
                role=IPAddressRoleEnum.LOOPBACK,
                dns_name="nyc-app-01.example.com",
                vrf=vrfs[0],
                tenant=tenant
            ),
            IPAddress(
                ...
                status=IPAddressStatusEnum.ACTIVE,
                role=IPAddressRoleEnum.LOOPBACK,
                dns_name="nyc-app-02.example.com",
                vrf=vrfs[0],
                tenant=tenant
            ),
            IPAddress(
                ...
                status=IPAddressStatusEnum.ACTIVE,
                role=IPAddressRoleEnum.LOOPBACK,
                dns_name="nyc-db-01.example.com",
                vrf=vrfs[0],
                tenant=tenant
            ),
            # SJC Production IP Addresses - from 10.2.0.0/16 prefix
            IPAddress(
                address="10.2.1.10/32",
                name="SJC-APP-01",
                status=IPAddressStatusEnum.ACTIVE,
                role=IPAddressRoleEnum.LOOPBACK,
                dns_name="sjc-app-01.example.com",
                vrf=vrfs[0],
                tenant=tenant
            ),
            ...
            IPAddress(
                ...
                status=IPAddressStatusEnum.ACTIVE,
                role=IPAddressRoleEnum.LOOPBACK,
                dns_name="nyc-mgmt-01.example.com",
                vrf=vrfs[2],
                tenant=tenant
            ),
            IPAddress(
                ...
                status=IPAddressStatusEnum.ACTIVE,
                role=IPAddressRoleEnum.LOOPBACK,
                dns_name="sjc-mgmt-01.example.com",
                vrf=vrfs[2],
                tenant=tenant
            ),
            ...
            IPAddress(
                ...
                status=IPAddressStatusEnum.ACTIVE,
                role=IPAddressRoleEnum.LOOPBACK,
                dns_name="nyc-web-01.example.com",
                vrf=vrfs[3],
                tenant=tenant
            ),
            IPAddress(
                ...
                status=IPAddressStatusEnum.ACTIVE,
                role=IPAddressRoleEnum.LOOPBACK,
                dns_name="nyc-web-02.example.com",
                vrf=vrfs[3],
                tenant=tenant
            ),
            IPAddress(
                ...
                status=IPAddressStatusEnum.ACTIVE,
                role=IPAddressRoleEnum.LOOPBACK,
                dns_name="sjc-web-01.example.com",
                vrf=vrfs[3],
                tenant=tenant
            )
        ]
